...
//    TODO bug: when registering, this page navigates to home page instead of fridge
    ...
    @BindView(R.id.firstNameText)EditText mFirstName;
    @BindView(R.id.lastNameText) EditText mLastName;
    @BindView(R.id.emailText) EditText mEmail;
    @BindView(R.id.passwordText) EditText mPassword;
    @BindView(R.id.confirmPasswordEditText) EditText mConfirmPassword;

    @BindView(R.id.registerButton) Button mRegistrationButton;
